...
namespace affiliate_proj.API.Webhooks.Shopify
{
    ...
    public class ShopifyWebhookController : ControllerBase
    {
        ...
        private readonly IShopifyOrderWebhookProcessor _shopifyOrderWebhookProcessor;
        ...
        public ShopifyWebhookController(IShopifyWebhookService shopifyWebhookService, 
            ...
            IStoreService storeService, IConversionService conversionService, IEarnedCommissionService earnedCommissionService, IShopifyOrderWebhookProcessor shopifyOrderWebhookProcessor)
        {
            ...
            _shopifyOrderWebhookProcessor = shopifyOrderWebhookProcessor;
        }
        ...
        public async Task<IActionResult> PaidOrderAsync()
        {
            try
            {
                ...
                _shopifyOrderWebhookProcessor.HandlePaidOrderAsync(domain, shopifyWebhookId: orderId,
                    shopifyOrderId: orderNum,
        ...
        public async Task<IActionResult> FulfilledOrderAsync()
        {
            try
            {
                ...
                var conversion = await _conversionService.UpdateConversionFulfilledAsync(
                    Request.Headers["X-Shopify-Shop-Domain"].ToString(), (int) order.OrderNumber, 
                    order.FinancialStatus);
