...
public interface IShopifyStoreHelper
{
    ...
    Task<Core.Entities.Store> GetStoreByDomainAsync(string shop);
    Task<Core.Entities.Store?> GetStoreDetailsByShopifyStoreIdAsync(long shopifyStoreId);
    Task<bool> SetShopifyStoreAsync(string shop, AuthorizationResult authorizationResult, Guid userId);
